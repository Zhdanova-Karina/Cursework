...
void Game::initializePuzzles() {
    ...
    puzzles[1] = Puzzle(L"То ли зебра, то ли лесенка, прикоснись - и будет песенка.", 1, L"Это музыкальный инструмент.", L"У него есть черные и белые клавиши.", L"На нем можно играть мелодии.", L"Скрипка", L"Пианино", L"Гитара");
    puzzles[2] = Puzzle(L"Я говорю без рта и слышу без ушей. Что я такое?", 1, L"Это природное явление, которое ты можешь услышать.", L"Оно возникает, когда звук отражается от поверхности.", L"Ты можешь слышать его в горах или пещерах.", L"Голос", L"Эхо", L"Ветер");
}
